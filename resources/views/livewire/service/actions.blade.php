      ...
      <input type="file" class="hidden" id="pickphoto" wire:model="photo"/>
        <label class="form-control">
          ...
          <label class="form-control">
            ...
            <input type="text" placeholder="Type here" @class(['input input-bordered', 'input-error' => $errors->first('form.estimated_completion_time')]) wire:model="form.estimated_completion_time" />
          </label>
          <label class="form-control">
            <div class="label">
              <span class="label-text">Description</span>
            </div>
            <textarea placeholder="Tulis keterangan Service disini" @class(['textarea textarea-bordered', 'input-error' => $errors->first('form.description')]) wire:model="form.description" ></textarea>
          </label>
    </div>
